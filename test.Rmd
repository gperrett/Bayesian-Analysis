...
$$ regulation_i \sim Binomial(n,p_i) $$
$$logit(p_i) = \alpha \space + \beta \space ideology_i + \beta \space age_i + \beta \space race_i + \beta \space negative \space affect_i + \space \beta \space charged \space content_i + \beta \space deception_i + \space \beta \space correcting \space misinformation_i$$
